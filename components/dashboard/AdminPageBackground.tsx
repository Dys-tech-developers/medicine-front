...
export function AdminPageBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      ...
      {/* Patrón sutil alineado a medical.primary (#454c92) */}
      <div
        className="absolute inset-0 opacity-[0.35]"
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='52' height='52' viewBox='0 0 52 52' xmlns='http://www.w3.org/2000/svg'%3E%3Crect x='12' y='24' width='28' height='4' rx='2' fill='%23454c92' fill-opacity='0.07'/%3E%3Crect x='24' y='12' width='4' height='28' rx='2' fill='%23454c92' fill-opacity='0.07'/%3E%3C/svg%3E")`,
        }}
      />
      ...
      <div className="absolute inset-0 bg-linear-to-b from-white/70 via-white/20 to-medical-surface/90" />
      <div
